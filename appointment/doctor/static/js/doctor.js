...
// const {userlst} = require('../../../static/js/peer-client.js');
// src=/static/js/peer-client.js
// import {dummy} from "../static/js/peer-client.js";
// import {userlst} from "/static/js/peer-client.js";
var available_patients;
var appointments;
var lst1 = userlst;
console.log(lst1);
...
function Pager(tableName, itemsPerPage,id) {
  ...
  function feedData(tableData) {
    console.log(available_patients);
    var tableContent = "";
    ...
    tableContent += `<thead>
      ...
      $.each(tableData, function () {
        ...
        tableContent += '<td>' + '<span class="onlinepeers'+ this.pateint_name.replace(' ', '')+'" ></span>' + '</td>';
        tableContent += '</tr>';
      });
